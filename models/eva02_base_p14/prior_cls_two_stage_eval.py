...
# config
MODEL_ID = "eva02_base_patch14_224.mim_in22k"
...
def load_model_and_processor():
    global _TRANSFORM
    trunk = timm.create_model(MODEL_ID, pretrained=True, num_classes=0).to(DEVICE).eval()
    cfg = timm.data.resolve_model_data_config(trunk)
    _TRANSFORM = timm.data.create_transform(**cfg, is_training=False)
    print("Loaded:", MODEL_ID, "| embed_dim:", trunk.embed_dim,
          "| depth:", len(trunk.blocks), "| prefix:", trunk.num_prefix_tokens)
    return trunk, _TRANSFORM
